     ...
     <section style="width: 1200px; margin: 0 auto;">
        ...
        <div id="myPage-section2">
            <div id="myPage-section2-1">
                <img src="resources/images/img/22.PNG" alt="이미지">
                <br>
      ...
      <!-- 주소 변경용 Modal -->
       <div class="modal fade" id="updateAdModal">
		...
		<div class="myPage-section4">
			<form action="<%=contextPath %>/detailPage.bo" method="post">
			 <button type="submit" class="btn btn-sm btn-secondary updatest" >댓글확인용 임시버튼</button>
		 </div>
		<script>
           function listinit(){
                    //게시글 가져와서 그려주기
